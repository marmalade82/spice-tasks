...
import SpecificTaskListScreen from "src/Screens/Prototypes/SpecificTaskListsScreen";
...
import AddRepeatTaskScreen from "src/Screens/Tasks/AddRepeatTaskScreen";
...
export {
    ...
    AddRepeatTaskScreen as AddRepeatTask
}